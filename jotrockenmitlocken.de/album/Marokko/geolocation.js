...
var mymap = L.map('mapid').setView([33.581125, -7.591146], 4);
...
var marker = L.marker([33.581125, -7.591146]).addTo(mymap);
marker.bindPopup("<b>Hier liegt Marokko!</b><br>").openPopup();
