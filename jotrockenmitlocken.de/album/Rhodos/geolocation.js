...
var mymap = L.map('mapid').setView([36.434689, 28.217667], 4);
...
var marker = L.marker([36.434689, 28.217667]).addTo(mymap);
marker.bindPopup("<b>Hier liegt Rhodos!</b><br>").openPopup();
